  ...
  return (
    <div>
      <section className="px-6 py-12 w-10/12 mx-auto">
        <h2 className="text-4xl text-center text-green-500 font-bold mb-6">Featured Products</h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
          {products.map(p => (
            ...
            >
              ...
              <p className="font-semibold mt-1">Price: <span className='text-red-500'>${p.price}</span></p>
              <Link
                href={`/products/${p.id}`}
